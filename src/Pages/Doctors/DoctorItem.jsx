    ...
    return (
        <div className="flex flex-col lg:flex-row gap-5 mb-5 p-6 border border-gray-400 w-full rounded-md justify-between">
            <div className="flex flex-col lg:flex-row gap-5">
                <img src={image} className="w-full aspect-video object-top lg:w-[170px] lg:h-[170px] object-cover rounded-md" alt="" />
            ...
            <div className="flex gap-3 flex-col text-center">
                <Link to={`/doctor/profile/${_id}`} className="border hover:bg-blue-500 hover:text-white duration-200 border-blue-500 px-10 py-3">View Profile</Link>
